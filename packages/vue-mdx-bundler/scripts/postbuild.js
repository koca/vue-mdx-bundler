...
fs.renameSync(path.join(distPath, 'src/index.d.ts'), path.join(distPath, './index.d.ts'))
fs.renameSync(path.join(distPath, 'src/client.d.ts'), path.join(distPath, './client.d.ts'))
fs.rmdirSync(path.join(distPath, 'src'))
